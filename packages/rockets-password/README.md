...
[![NPM Latest](https://img.shields.io/npm/v/@concepta/rockets-password)](https://www.npmjs.com/package/@concepta/rockets-password)
[![NPM Downloads](https://img.shields.io/npm/dw/@conceptadev/rockets-password)](https://www.npmjs.com/package/@concepta/rockets-password)
...
```sh
yarn add @concepta/rockets-password
```
...
| --- | --- |
| `@concepta/rockets-password` | Module, policy, services, commands, command handlers, exceptions, enums, interfaces |
