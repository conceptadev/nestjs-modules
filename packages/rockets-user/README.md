...
[![NPM Latest](https://img.shields.io/npm/v/@concepta/rockets-user)](https://www.npmjs.com/package/@concepta/rockets-user)
[![NPM Downloads](https://img.shields.io/npm/dw/@concepta/rockets-user)](https://www.npmjs.com/package/@concepta/rockets-user)
...
```sh
yarn add @concepta/rockets-user
```
...
| `@concepta/rockets-password` | Password hashing and validation |
...
import { UserModule } from '@concepta/rockets-user';
...
import { CreateUserCommand, User } from '@concepta/rockets-user';
...
`CrudModule.forFeature()` from `@concepta/rockets-crud`.
...
} from '@concepta/rockets-user/optional/crud';
```
...
```ts
import { UserFactory } from '@concepta/rockets-user/optional/seeding';
```
...
| --- | --- |
| `@concepta/rockets-user` | Module, aggregates, commands, queries, events, handlers, DTOs, repositories, exceptions, domain interfaces |
| `@concepta/rockets-user/optional/crud` | CRUD request/handler classes, paginated DTO |
| `@concepta/rockets-user/optional/typeorm` | `UserSqliteEntity`, `UserPostgresEntity`, `UserCredentialSqliteEntity`, `UserCredentialPostgresEntity` |
| `@concepta/rockets-user/optional/seeding` | `UserFactory`, `UserCredentialFactory`, `UserSeeder` |
