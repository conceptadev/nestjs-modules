...
[![NPM Latest](https://img.shields.io/npm/v/@concepta/rockets-invitation)](https://www.npmjs.com/package/@concepta/rockets-invitation)
[![NPM Downloads](https://img.shields.io/npm/dw/@conceptadev/rockets-invitation)](https://www.npmjs.com/package/@concepta/rockets-invitation)
...
```sh
yarn add @concepta/rockets-invitation
```
...
| `@concepta/rockets-repository-typeorm` | No | Only if using the TypeORM repository adapter |
...
```ts
import { InvitationModule } from '@concepta/rockets-invitation';
...
import { CreateInvitationCommand, Invitation } from '@concepta/rockets-invitation';
...
import { GetInvitationQuery, Invitation } from '@concepta/rockets-invitation';
...
import { InvitationAcceptedEvent } from '@concepta/rockets-invitation';
...
The gateway layer bridges `@concepta/rockets-crud` operations to domain
...
} from '@concepta/rockets-invitation';
...
| --- | --- |
| `@concepta/rockets-invitation` | Module, aggregate, commands, queries, events, handlers, ports, policies, DTOs, repository, mapper, exceptions |
| `@concepta/rockets-invitation/optional/typeorm` | `InvitationSqliteEntity`, `InvitationPostgresEntity` |
...
```ts
import { InvitationFactory } from '@concepta/rockets-invitation';
```
