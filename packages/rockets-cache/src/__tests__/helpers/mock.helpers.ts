...
import { CrudContextInterface, CrudCtx } from '@concepta/rockets-crud';
import { createMockTransaction } from '@concepta/rockets-repository/testing';
...
export type { MockTransactionHandle } from '@concepta/rockets-repository/testing';
