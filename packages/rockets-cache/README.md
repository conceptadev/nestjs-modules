...
[![NPM Latest](https://img.shields.io/npm/v/@concepta/rockets-cache)](https://www.npmjs.com/package/@concepta/rockets-cache)
[![NPM Downloads](https://img.shields.io/npm/dw/@concepta/rockets-cache)](https://www.npmjs.com/package/@concepta/rockets-cache)
...
```sh
yarn add @concepta/rockets-cache
```
...
| `@concepta/rockets-crud` | No | Only if using the HTTP gateway layer |
...
```ts
import { CacheModule } from '@concepta/rockets-cache';
...
- **Gateway** -- HTTP request handlers bridging `@concepta/rockets-crud`
  to domain commands
...
```ts
import { CacheNamespace } from '@concepta/rockets-cache';
...
import { CreateCacheCommand, Cache } from '@concepta/rockets-cache';
...
import { FindOneCacheQuery, Cache } from '@concepta/rockets-cache';
...
import { CacheCreatedEvent } from '@concepta/rockets-cache';
...
Use `@concepta/rockets-crud` to expose cache operations as REST endpoints. The
gateway request/handler classes are exported from
`@concepta/rockets-cache/optional/crud`.

```ts
import { Module } from '@nestjs/common';
import { Operation } from '@concepta/rockets-app';
import { CacheInterface } from '@concepta/rockets-cache';
import { CrudCqrsResolver, CrudModule } from '@concepta/rockets-crud';
import {
  CacheModule,
  CacheCreateDto,
  CacheUpdateDto,
...
} from '@concepta/rockets-cache/optional/crud';
...
and per-operation overrides. See the `@concepta/rockets-crud` documentation
for the full API.
...
| --- | --- |
| `@concepta/rockets-cache` | Module, aggregate, commands, queries, events, handlers, DTOs, repository, exceptions, domain interfaces |
| `@concepta/rockets-cache/optional/crud` | CRUD request/handler classes, paginated DTO |
| `@concepta/rockets-cache/optional/typeorm` | `CacheSqliteEntity`, `CachePostgresEntity` |
| `@concepta/rockets-cache/optional/seeding` | `CacheFactory` |
...
```ts
import { CacheFactory } from '@concepta/rockets-cache/optional/seeding';
```
