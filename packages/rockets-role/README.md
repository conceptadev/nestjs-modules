...
[![NPM Latest](https://img.shields.io/npm/v/@concepta/rockets-role)](https://www.npmjs.com/package/@concepta/rockets-role)
[![NPM Downloads](https://img.shields.io/npm/dw/@concepta/rockets-role)](https://www.npmjs.com/package/@concepta/rockets-role)
...
```sh
yarn add @concepta/rockets-role
```
...
| `@concepta/rockets-repository` | Repository abstraction and transaction scope |
...
| `@concepta/rockets-crud` | No | Only when using the CRUD HTTP gateway |
...
import { RoleEntityInterface, RoleAssignmentEntityInterface } from '@concepta/rockets-role';
...
import { RoleModule } from '@concepta/rockets-role';
...
import { CreateRoleCommand, GetRoleQuery, AssignRoleCommand } from '@concepta/rockets-role';
...
- **Gateway** — Adapts HTTP requests to CQRS commands/queries. Optional;
  requires `@concepta/rockets-crud`.
...
```ts
import { RoleNamespace } from '@concepta/rockets-role';
...
import { RoleAssignedEvent } from '@concepta/rockets-role';
...
controller via `CrudModule.forFeature()` from `@concepta/rockets-crud`.
...
import {
  ...
  // ...
} from '@concepta/rockets-role/optional/crud';
```
...
Exported from `@concepta/rockets-role`:
...
Exported from `@concepta/rockets-role/optional/crud`:
...
```ts
import { RoleFactory } from '@concepta/rockets-role/optional/seeding';
```
...
| --- | --- |
| `@concepta/rockets-role` | Module, aggregates, commands, queries, events, handlers, DTOs, repositories, exceptions, domain interfaces, types |
| `@concepta/rockets-role/optional/crud` | CRUD request/handler classes, paginated DTOs, batch DTOs |
| `@concepta/rockets-role/optional/typeorm` | `RoleSqliteEntity`, `RolePostgresEntity`, `RoleAssignmentSqliteEntity`, `RoleAssignmentPostgresEntity` |
| `@concepta/rockets-role/optional/seeding` | `RoleFactory` |
