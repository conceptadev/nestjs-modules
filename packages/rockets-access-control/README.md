...
[![NPM Latest](https://img.shields.io/npm/v/@concepta/rockets-access-control)](https://www.npmjs.com/package/@concepta/rockets-access-control)
[![NPM Downloads](https://img.shields.io/npm/dw/@concepta/rockets-access-control)](https://www.npmjs.com/package/@concepta/rockets-access-control)
...
Install the `@concepta/rockets-access-control` package using yarn or npm:

```sh
yarn add @concepta/rockets-access-control
```

```sh
npm install @concepta/rockets-access-control
```

## Basic Setup

To set up the `@concepta/rockets-access-control` module, you need to
...
```typescript
import { AccessControlServiceInterface } from '@concepta/rockets-access-control';
...
} from '@concepta/rockets-access-control';
...
1. **Define the Service**: Create a new service class that
   implements `CanAccess` from `@concepta/rockets-access-control`.
...
import { AccessControlModule } from '@concepta/rockets-access-control';
