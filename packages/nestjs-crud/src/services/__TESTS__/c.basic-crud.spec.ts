...
import { CrudCreateBatchHandler } from '../../crud/operations/handlers/crud-create-batch.handler';
import { CrudCreateHandler } from '../../crud/operations/handlers/crud-create.handler';
import { CrudDeleteHandler } from '../../crud/operations/handlers/crud-delete.handler';
...
import { CrudReplaceHandler } from '../../crud/operations/handlers/crud-replace.handler';
import { CrudRestoreHandler } from '../../crud/operations/handlers/crud-restore.handler';
import { CrudSoftDeleteHandler } from '../../crud/operations/handlers/crud-soft-delete.handler';
...
describe('#crud-typeorm', () => {
  ...
  describe('#basic crud', () => {
    ...
    class CompaniesController {
      ...
      create(
        @Ctx() context: CrudContextInterface<CompanyEntity>,
      ...
      delete(@Ctx() context: CrudContextInterface<CompanyEntity>) {
      ...
      softDelete(@Ctx() context: CrudContextInterface<CompanyEntity>) {
      ...
      restore(@Ctx() context: CrudContextInterface<CompanyEntity>) {
      ...
      restoreWithBody(@Ctx() context: CrudContextInterface<CompanyEntity>) {
        return this.crudResolver.restore(context);
      }
      ...
      deleteSilent(@Ctx() context: CrudContextInterface<CompanyEntity>) {
        return this.crudResolver.delete(context);
      }
    }
    ...
    class DevicesController {
      ...
      create(
        @Ctx() context: CrudContextInterface<DeviceEntity>,
