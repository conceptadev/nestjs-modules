...
export const CRUD_MODULE_ROUTE_REQUIRE_VERSION_METADATA =
  'CRUD_MODULE_ROUTE_REQUIRE_VERSION_METADATA';
...
export const CRUD_MODULE_API_BODY_METADATA = 'CRUD_MODULE_API_BODY_METADATA';
