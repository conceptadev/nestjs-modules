...
[![NPM Latest](https://img.shields.io/npm/v/@concepta/rockets-otp)](https://www.npmjs.com/package/@concepta/rockets-otp)
[![NPM Downloads](https://img.shields.io/npm/dw/@concepta/rockets-otp)](https://www.npmjs.com/package/@concepta/rockets-otp)
...
```ts
import { OtpModule } from '@concepta/rockets-otp';
...
import { CreateOtpCommand, Otp } from '@concepta/rockets-otp';
...
import { ValidateOtpQuery } from '@concepta/rockets-otp';
...
import { OtpCreatedEvent } from '@concepta/rockets-otp';
...
REST endpoints via `@concepta/rockets-crud`, create custom request and handler
...
```ts
import { OtpCreatableInterface, OtpInterface } from '@concepta/rockets-app';
...
import { OtpInterface, Operation } from '@concepta/rockets-app';
import { CrudCqrsResolver, CrudModule } from '@concepta/rockets-crud';
import { OtpModule, OtpCreateDto } from '@concepta/rockets-otp';
...
pairs following the same pattern. See the `@concepta/rockets-crud` documentation
for the full API.
...
| --- | --- |
| `@concepta/rockets-otp` | Module, aggregate, commands, queries, events, handlers, DTOs, repository, exceptions, domain interfaces |
| `@concepta/rockets-otp/optional/typeorm` | `OtpSqliteEntity`, `OtpPostgresEntity` |
| `@concepta/rockets-otp/optional/seeding` | `OtpFactory` |
...
```ts
import { OtpFactory } from '@concepta/rockets-otp/optional/seeding';
```
