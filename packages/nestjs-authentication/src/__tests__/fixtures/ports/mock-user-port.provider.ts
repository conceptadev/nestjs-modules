...
export class MockGetUserByIdHandler
  implements IQueryHandler<MockGetUserByIdQuery>
{
  async execute(
...
export class MockGetUserBySubjectHandler
  implements IQueryHandler<MockGetUserBySubjectQuery>
{
  async execute(
...
export class MockGetUserByUsernameHandler
  implements IQueryHandler<MockGetUserByUsernameQuery>
{
  async execute(
...
export class MockGetUserByEmailHandler
  implements IQueryHandler<MockGetUserByEmailQuery>
{
  async execute(
...
export class MockUpdateUserHandler
  implements ICommandHandler<MockUpdateUserCommand>
{
  async execute(
